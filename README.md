...
```sh
git clone git@github.com:Emin017/chisel-panama-template.git
cd chisel-panama-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-panama-template'
...
```sh
mill chisel-panama-template.test
```
